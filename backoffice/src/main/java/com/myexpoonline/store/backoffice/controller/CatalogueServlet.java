...
public class CatalogueServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Injection des éléments en HTML
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<p>Bienvenue "+ session.getAttribute("username") +" (<a href='logout'>Déconnexion</a>)</p>");
        ...
        out.println("<a href='add-work.html'>Ajoutez un élément au catalogue</a>");
        out.println("</body>");
        out.println("</html>");
